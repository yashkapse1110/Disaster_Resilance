...
const NearbyFireAuthorities = () => {
  ...
  useEffect(() => {
    ...
    const hardcodedStations = [
      { name: "Flood Rescue Tillotama", phone: "9804445566", distance: "1.8 km" },
      { name: "Tillotama Water Dept", phone: "9805556677", distance: "4.2 km" },
      {
        name: "Disaster Response Tillotama",
        phone: "9806667788",
        distance: "6 km",
      },
    ];
  ...
  return (
    <div className="bg-[#f4f7fe] px-4 pt-4 pb-24 text-gray-800">
      ...
      <h2 className="text-lg font-semibold mb-4">
        {t("floodAuthorities.nearbyFloodAuthorities")}
      </h2>
