...
const NearbyFireAuthorities = () => {
  ...
  useEffect(() => {
    ...
    const hardcodedStations = [
      {
        name: "Landslide Rescue Bhairahawa",
        phone: "9810001122",
        distance: "3.0 km",
      },
      { name: "Geo Disaster Team", phone: "9811112233", distance: "6.4 km" },
      {
        name: "Siddharthanagar Disaster Control",
        phone: "9812223344",
        distance: "9.1 km",
      },
    ];
